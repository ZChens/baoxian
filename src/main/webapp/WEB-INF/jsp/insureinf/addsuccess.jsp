...
<div class="bo">
    <label>恭喜您！购买成功</label>
    <a href="${pageContext.request.contextPath}/insureinf/SelectInsureById.action?userid=${sessionScope.user.userid}" type="button" class="btn btn-default">查看订单</a>
</div>
